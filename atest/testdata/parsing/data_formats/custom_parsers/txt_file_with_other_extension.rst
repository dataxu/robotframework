This is a 'txt' format file, but the extension is '.tsv' so that we
can test the --parser cli option
...
NÃ¶n-Ã¤scÃ¯Ã¯
      [Documentation]   FAIL NÃ¶n-Ã¤scÃ¯Ã¯ error
      Fail    NÃ¶n-Ã¤scÃ¯Ã¯ error
